 ...
 */
public interface BaseUnivariateSolver<T extends UnivariateFunction> {
    /**
     ...
     */
    double solve(int maxEval, T f, double min, double max)
     ...
     * the allowed number of evaluations is exceeded.
     */
    double solve(int maxEval, T f, double min, double max, double startValue)
        throws MathIllegalArgumentException, TooManyEvaluationsException;
     ...
     * the allowed number of evaluations is exceeded.
     */
    double solve(int maxEval, T f, double startValue);
}
