 ...
 */
@Deprecated
public abstract class BaseAbstractMultivariateSimpleBoundsOptimizer<T extends MultivariateFunction>
    extends BaseAbstractMultivariateOptimizer<T>
    implements BaseMultivariateOptimizer<T>,
               BaseMultivariateSimpleBoundsOptimizer<T> {
    /**
    ...
    /** {@inheritDoc} */
    @Override
    public PointValuePair optimize(int maxEval, T f, GoalType goalType,
                                   double[] startPoint) {
