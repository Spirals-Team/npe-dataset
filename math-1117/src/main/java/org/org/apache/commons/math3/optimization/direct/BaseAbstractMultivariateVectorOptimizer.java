 ...
 */
@Deprecated
public abstract class BaseAbstractMultivariateVectorOptimizer<T extends MultivariateVectorFunction>
     ...
     */
    @Deprecated
    public PointVectorValuePair optimize(int maxEval, T f, double[] t, double[] w,
                                         double[] startPoint) {
     ...
     */
    @Deprecated
    protected PointVectorValuePair optimizeInternal(final int maxEval, final T f,
     ...
     * @since 3.1
     */
    protected T getObjectiveFunction() {
        return function;
    }
