 ...
 */
@Deprecated
public abstract class BaseAbstractMultivariateOptimizer<T extends MultivariateFunction>
     ...
     */
    @Deprecated
    protected PointValuePair optimizeInternal(int maxEval, T f, GoalType goalType,
                                              double[] startPoint) {
        return optimizeInternal(maxEval, f, goalType, new InitialGuess(startPoint));
    }
