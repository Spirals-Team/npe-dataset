 ...
 *
 * @param <T> Type of the point/value pair returned by the optimization
 * algorithm.
 *
...
public abstract class BaseMultiStartMultivariateOptimizer<T>
     ...
     */
    public BaseMultiStartMultivariateOptimizer(final BaseMultivariateOptimizer<T> optimizer,
                                               final int starts,
    ...
    protected T doOptimize() {
        ...
        for (int i = 0; i < starts; i++) {
            ...
            try {
                ...
                // Optimize.
                final T result = optimizer.optimize(optimData);
                store(result);
