 ...
 */
@Deprecated
public class BaseMultivariateMultiStartOptimizer<T extends MultivariateFunction>
     ...
     */
    protected BaseMultivariateMultiStartOptimizer(final BaseMultivariateOptimizer<T> optimizer,
                                                      final int starts,
     ...
     * {@inheritDoc}
     */
    public PointValuePair optimize(int maxEval, final T f,
                                       final GoalType goal,
                                       double[] startPoint) {
