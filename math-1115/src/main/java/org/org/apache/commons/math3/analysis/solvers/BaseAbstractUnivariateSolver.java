 ...
 * solvers.
 *
 * @param <T> Type of function to solve.
 *
 * @since 2.0
 * @version $Id: BaseAbstractUnivariateSolver.java 1455194 2013-03-11 15:45:54Z luc $
 */
public abstract class BaseAbstractUnivariateSolver<T extends UnivariateFunction>
    implements BaseUnivariateSolver<T> {
    ...
    /** {@inheritDoc} */
    public double solve(int maxEval, T f, double min, double max, double startValue)
        throws TooManyEvaluationsException,
    ...
    /** {@inheritDoc} */
    public double solve(int maxEval, T f, double min, double max) {
        return solve(maxEval, f, min, max, min + 0.5 * (max - min));
    }

    /** {@inheritDoc} */
    public double solve(int maxEval, T f, double startValue)
        throws TooManyEvaluationsException,
               NoBracketingException {
