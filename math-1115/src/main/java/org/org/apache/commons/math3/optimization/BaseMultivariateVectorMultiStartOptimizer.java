 ...
 *
 * @param <T> Type of the objective function to be optimized.
 *
 ...
 */
@Deprecated
public class BaseMultivariateVectorMultiStartOptimizer<T extends MultivariateVectorFunction>
    implements BaseMultivariateVectorOptimizer<T> {
    /** Underlying classical optimizer. */
    private final BaseMultivariateVectorOptimizer<T> optimizer;
     ...
     */
    protected BaseMultivariateVectorMultiStartOptimizer(final BaseMultivariateVectorOptimizer<T> optimizer,
                                                           final int starts,
     ...
     * {@inheritDoc}
     */
    public PointVectorValuePair optimize(int maxEval, final T f,
